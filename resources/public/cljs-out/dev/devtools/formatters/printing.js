...
var len__4736__auto___12879 = arguments.length;
var i__4737__auto___12880 = (0);
while(true){
if((i__4737__auto___12880 < len__4736__auto___12879)){
args__4742__auto__.push((arguments[i__4737__auto___12880]));

var G__12881 = (i__4737__auto___12880 + (1));
i__4737__auto___12880 = G__12881;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12876){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12877,G__12878,seq12876__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12882_SHARP_){
return (!((cljs.core.meta.call(null,p1__12882_SHARP_) == null)));
})))){
...
var map__12883 = opts;
var map__12883__$1 = (((((!((map__12883 == null))))?(((((map__12883.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12883.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12883):map__12883);
var markup_db = cljs.core.get.call(null,map__12883__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12887){var _e__12507__auto__ = e12887;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e12889){var _e__12507__auto__ = e12889;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12891 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12892 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12892);

try{var map__12893 = opts;
...
var markup_db = cljs.core.get.call(null,map__12893__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12891);
}});
...
var temp__5718__auto___12898 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___12898)){
var managed_print_level_12899 = temp__5718__auto___12898;
var _STAR_print_level_STAR__orig_val__12896_12900 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12897_12901 = managed_print_level_12899;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12897_12901);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__12895_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__12895_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12896_12900);
}} else {
job_fn.call(null);
}
