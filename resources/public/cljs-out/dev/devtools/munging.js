...
var o12745 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12745["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12746 = temp__5718__auto____$1;
return (o12746["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12500__auto__ = f;
return (o__12500__auto__["toString"]).call(o__12500__auto__);
} else {
return "";
}
}catch (e12747){var _ = e12747;
return "";
}});
...
try{var o__12500__auto___12749 = t;
(o__12500__auto___12749["cljs$lang$ctorPrWriter"]).call(o__12500__auto___12749,t,writer);
}catch (e12748){var __12750 = e12748;
}
...
var char_code = (function (){var o__12500__auto__ = (new String(char$));
return (o__12500__auto__["charCodeAt"]).call(o__12500__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12500__auto__ = String;
return (o__12500__auto__["fromCharCode"]).call(o__12500__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12751 = num_code;
switch (G__12751) {
case (1):
return (185);
...
var o__12500__auto__ = String;
return (o__12500__auto__["fromCharCode"]).call(o__12500__auto__,superscript_code);
});
/**
...
}catch (e12753){var _e__12507__auto__ = e12753;
return false;
}})())){
...
var vec__12754 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12754,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o12757 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12757["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12758 = temp__5718__auto____$1;
return (o12758["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___12765 = arguments.length;
var i__4737__auto___12766 = (0);
while(true){
if((i__4737__auto___12766 < len__4736__auto___12765)){
args__4742__auto__.push((arguments[i__4737__auto___12766]));

var G__12767 = (i__4737__auto___12766 + (1));
i__4737__auto___12766 = G__12767;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12761){
var vec__12762 = p__12761;
var ns_detector = cljs.core.nth.call(null,vec__12762,(0),null);
...
var G__12768 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12769 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12768;
remaining_tokens = G__12769;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12759){
...
var vec__12773 = cljs.core.split_with.call(null,(function (p1__12772_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12772_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12773,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12773,(1),null);
...
var vec__12779 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12779,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12779,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12782 = cljs.core.rest.call(null,remaining_tokens);
var G__12783 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12782;
name_tokens = G__12783;
continue;
} else {
...
var vec__12786 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12786,(0),null);
var arity = cljs.core.nth.call(null,vec__12786,(1),null);
var vec__12789 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12789,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12789,(1),null);
var vec__12792 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12792,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12792,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12792,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12792,(3),null);
...
var vec__12798 = result;
var munged_ns = cljs.core.nth.call(null,vec__12798,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12798,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12798,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12798,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12798,(4),null);
var arity = cljs.core.nth.call(null,vec__12798,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__12802 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__12802,(0),null);
var args = cljs.core.nth.call(null,vec__12802,(1),null);
var vec__12805 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12805,(0),null);
var name = cljs.core.nth.call(null,vec__12805,(1),null);
...
var G__12808 = (arity + (1));
var G__12809 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12810){
var vec__12811 = p__12810;
var arity = cljs.core.nth.call(null,vec__12811,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12811,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12814_SHARP_){
return cljs.core.get.call(null,arities,p1__12814_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12815_SHARP_){
return cljs.core.drop.call(null,(2),p1__12815_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12818){
var vec__12819 = p__12818;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12819,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12816){
var G__12817 = cljs.core.first.call(null,seq12816);
var seq12816__$1 = cljs.core.next.call(null,seq12816);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12817,seq12816__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12827__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12827__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12827__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12827__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12828 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12828,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12828,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12828,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12828,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12828,(4),null);
var arity = cljs.core.nth.call(null,vec__12828,(5),null);
...
var o__12500__auto__ = f;
return (o__12500__auto__["getBasis"]).call(o__12500__auto__);
});
/**
...
}catch (e12832){var _e__12507__auto__ = e12832;
...
var G__12833 = (obj[cljs.core.first.call(null,path)]);
var G__12834 = cljs.core.rest.call(null,path);
obj = G__12833;
path = G__12834;
continue;
} else {
...
var _STAR_ = (function (accum,p__12835){
var vec__12836 = p__12835;
var bit = cljs.core.nth.call(null,vec__12836,(0),null);
var protocol = cljs.core.nth.call(null,vec__12836,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12839){
var vec__12840 = p__12839;
var ns = cljs.core.nth.call(null,vec__12840,(0),null);
var name = cljs.core.nth.call(null,vec__12840,(1),null);
var selector = cljs.core.nth.call(null,vec__12840,(2),null);
...
var post_process = (function (p__12844){
var vec__12845 = p__12844;
var munged_name = cljs.core.nth.call(null,vec__12845,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12845,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12843_SHARP_){
return (obj[cljs.core.first.call(null,p1__12843_SHARP_)]);
}),sorted_matches);
