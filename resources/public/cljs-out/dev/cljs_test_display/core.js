...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_11595);
...
var len__4736__auto___11599 = arguments.length;
var i__4737__auto___11600 = (0);
while(true){
if((i__4737__auto___11600 < len__4736__auto___11599)){
args__4742__auto__.push((arguments[i__4737__auto___11600]));

var G__11601 = (i__4737__auto___11600 + (1));
i__4737__auto___11600 = G__11601;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq11596){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11597,G__11598,seq11596__$2);
}));
...
var vec__11602 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__11602,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__11602,(1),null);
var G__11605 = cljs.core.PersistentArrayMap.EMPTY;
var G__11605__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__11605,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11605);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__11605__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__11605__$1;
}
} else {
...
return (function() { 
var G__11609__delegate = function (klass,contents){
var vec__11606 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__11606,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__11606,(1),null);
...
var G__11609 = function (klass,var_args){
var contents = null;
...
while (G__11610__i < G__11610__a.length) {G__11610__a[G__11610__i] = arguments[G__11610__i + 1]; ++G__11610__i;}
  contents = new cljs.core.IndexedSeq(G__11610__a,0,null);
} 
return G__11609__delegate.call(this,klass,contents);};
G__11609.cljs$lang$maxFixedArity = 1;
G__11609.cljs$lang$applyTo = (function (arglist__11611){
var klass = cljs.core.first(arglist__11611);
var contents = cljs.core.rest(arglist__11611);
return G__11609__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__11615){
...
var ns = cljs.core.get.call(null,map__11616__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__11616__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__11618){
var map__11619 = p__11618;
var map__11619__$1 = (((((!((map__11619 == null))))?(((((map__11619.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11619.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11619):map__11619);
var actual = cljs.core.get.call(null,map__11619__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__11619__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__11621){
...
var expected = cljs.core.get.call(null,map__11622__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__11622__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__11624_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__11624_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__11626 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__11626__$1;
var name = cljs.core.get.call(null,map__11626__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__11626__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__11626__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__11625_SHARP_){
return cljs.core.cons.call(null,node,p1__11625_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__11628){
...
var m = map__11629__$1;
var fail = cljs.core.get.call(null,map__11629__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__11629__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__11629__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__11629__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___11631 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11631)){
var message_11632 = temp__5720__auto___11631;
cljs.core.println.call(null,message_11632);
} else {
}
...
var temp__5720__auto___11633 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11633)){
var message_11634 = temp__5720__auto___11633;
cljs.core.println.call(null,message_11634);
} else {
}
