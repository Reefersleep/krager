...
return cljs.core.map.call(null,(function (p1__11570_SHARP_){
return html_coll.item(p1__11570_SHARP_);
...
return cljs.core.some.call(null,(function (p1__11571_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__11571_SHARP_);
...
var ctx_11572 = cvs.getContext("2d");
(ctx_11572.fillStyle = color);

ctx_11572.fillRect((0),(0),size,size);
