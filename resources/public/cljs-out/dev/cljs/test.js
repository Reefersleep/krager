...
var G__11289 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11289,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11289;
}
}));
...
var len__4736__auto___11294 = arguments.length;
var i__4737__auto___11295 = (0);
while(true){
if((i__4737__auto___11295 < len__4736__auto___11294)){
args__4742__auto__.push((arguments[i__4737__auto___11295]));

var G__11296 = (i__4737__auto___11295 + (1));
i__4737__auto___11295 = G__11296;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11291){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11292,G__11293,seq11291__$2);
}));
...
var file = cljs.core.get.call(null,map__11298__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11298__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11298__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11297_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11297_SHARP_));
...
var temp__5720__auto___11300 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11300)){
var message_11301 = temp__5720__auto___11300;
cljs.core.println.call(null,message_11301);
} else {
}
...
var temp__5720__auto___11302 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11302)){
var message_11303 = temp__5720__auto___11302;
cljs.core.println.call(null,message_11303);
} else {
}
...
var output_dir__$1 = (function (){var G__11304 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11304,"/"].join('');
} else {
return G__11304;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11306 = exception.stack;
var G__11306__$1 = (((G__11306 == null))?null:clojure.string.split_lines.call(null,G__11306));
var G__11306__$2 = (((G__11306__$1 == null))?null:cljs.core.get.call(null,G__11306__$1,depth));
if((G__11306__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11306__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11307 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11307,(0),null);
var column = cljs.core.nth.call(null,vec__11307,(1),null);
var vec__11310 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11310,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11310,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11310,(2),null);
...
var m__$1 = (function (){var G__11313 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__11313__$1 = (((G__11313 instanceof cljs.core.Keyword))?G__11313.fqn:null);
switch (G__11313__$1) {
case "fail":
...
var G__11317 = (function (){var G__11316 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11316);
} else {
return G__11316;
}
})();
...
return cljs.core.vary_meta.call(null,G__11318,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e11319){var e = e11319;
var G__11320 = e;
var G__11320__$1 = (((G__11320 instanceof cljs.core.Keyword))?G__11320.fqn:null);
switch (G__11320__$1) {
...
var vec__11322 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11322,(0),null);
var types = vec__11322;
...
return cljs.core.map.call(null,(function (p__11325){
var vec__11326 = p__11325;
var ns = cljs.core.nth.call(null,vec__11326,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11326,(1),null);
return (function (){
...
var G__11329 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11329__$1 = (((G__11329 instanceof cljs.core.Keyword))?G__11329.fqn:null);
switch (G__11329__$1) {
case "async":
...
var seq__11330 = cljs.core.seq.call(null,vars__$1);
var chunk__11331 = null;
var count__11332 = (0);
var i__11333 = (0);
while(true){
if((i__11333 < count__11332)){
var v = cljs.core._nth.call(null,chunk__11331,i__11333);
var temp__5720__auto___11335 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11335)){
var t_11336 = temp__5720__auto___11335;
each_fixture_fn.call(null,((function (seq__11330,chunk__11331,count__11332,i__11333,t_11336,temp__5720__auto___11335,v,each_fixture_fn,G__11329,G__11329__$1,env,once_fixtures,each_fixtures,vec__11326,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11336)));
});})(seq__11330,chunk__11331,count__11332,i__11333,t_11336,temp__5720__auto___11335,v,each_fixture_fn,G__11329,G__11329__$1,env,once_fixtures,each_fixtures,vec__11326,ns,vars__$1))
);
} else {
}


var G__11337 = seq__11330;
var G__11338 = chunk__11331;
var G__11339 = count__11332;
var G__11340 = (i__11333 + (1));
seq__11330 = G__11337;
chunk__11331 = G__11338;
count__11332 = G__11339;
i__11333 = G__11340;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11330);
if(temp__5720__auto__){
var seq__11330__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11330__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11330__$1);
var G__11341 = cljs.core.chunk_rest.call(null,seq__11330__$1);
var G__11342 = c__4556__auto__;
var G__11343 = cljs.core.count.call(null,c__4556__auto__);
var G__11344 = (0);
seq__11330 = G__11341;
chunk__11331 = G__11342;
count__11332 = G__11343;
i__11333 = G__11344;
continue;
} else {
var v = cljs.core.first.call(null,seq__11330__$1);
var temp__5720__auto___11345__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11345__$1)){
var t_11346 = temp__5720__auto___11345__$1;
each_fixture_fn.call(null,((function (seq__11330,chunk__11331,count__11332,i__11333,t_11346,temp__5720__auto___11345__$1,v,seq__11330__$1,temp__5720__auto__,each_fixture_fn,G__11329,G__11329__$1,env,once_fixtures,each_fixtures,vec__11326,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11346)));
});})(seq__11330,chunk__11331,count__11332,i__11333,t_11346,temp__5720__auto___11345__$1,v,seq__11330__$1,temp__5720__auto__,each_fixture_fn,G__11329,G__11329__$1,env,once_fixtures,each_fixtures,vec__11326,ns,vars__$1))
);
} else {
}


var G__11347 = cljs.core.next.call(null,seq__11330__$1);
var G__11348 = null;
var G__11349 = (0);
var G__11350 = (0);
seq__11330 = G__11347;
chunk__11331 = G__11348;
count__11332 = G__11349;
i__11333 = G__11350;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11329__$1)].join('')));
