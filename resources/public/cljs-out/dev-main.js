window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=9a0a80&fwbuild=dev"};
...
document.write('<script>goog.require("krager.core");</script>');
